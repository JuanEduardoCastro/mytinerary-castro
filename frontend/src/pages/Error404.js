            ...
            <div>
                ...
                <div className="w-full h-screen flex flex-col items-center justify-start text-center">
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 text-2xl">
                        ...
                        <h2>Go back to <Link to="/" ><span className="hover:text-indigo-700 transition-all hover:scale-110 py-2 permanentMarkerFont text-5xl"> Mytinerary </span></Link> home page.</h2>
                    </div>
                </div> 
            </div>
        </>    
